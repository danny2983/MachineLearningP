---
title: "Machine Learning Exercise Manner Prediction"
...
```{r packages}
pacman::p_load(data.table, caret, parallel, doParallel, purrr, visdat, dplyr, printr, kableExtra, corrplot, e1071, randomForest,rpart,rattle)
```
...
saveRDS(rf.fit,file="rfmodel2023.rds")
```

### Building the model Desicion Tree
```{r rfmodelTree}
